...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							...
							<input readonly type='text' class='form-control data-sending input-simple-date' placeholder='' id='tanggal_pencatatan' value='<?php if(isset($data)) echo $data->tanggal_pencatatan?>'>
							</div>
					</div>
					</div>
