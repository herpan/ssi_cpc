											...
											{data:null,width:"5%",
												...
												render: function ( data, type, row ) {
														if ( type === 'display' ) {
															...
															btn_group = btn_group + '<a href="<?php echo $link_view ?>/' + row.id + '" class="btn btn-default text-red btn-sm " title="Lihat Berita Acara Pengiriman Uang" target="_blank"><i class="fa fa-file-o"></i></a>';
															btn_group = btn_group + '<a href="<?php echo $link_update?>/'+row.id+'" class="btn btn-default text-red btn-sm " title="Lihat Pengiriman Uang Detail"><i class="fe fe-arrow-right"></i></a>';
