											...
											{data:null,width:"5%",
												...
												render: function ( data, type, row ) {
														if ( type === 'display' ) {															
															...
															btn_group = btn_group + '<a href="<?php echo $link_view ?>/' + row.id + '" class="btn btn-default text-red btn-sm " title="Berita Acara Penerimaan" target="_blank"><i class="fa fa-file-o"></i></a>';
															btn_group = btn_group + '<a href="<?php echo $link_update?>/'+row.id+'" class="btn btn-default text-red btn-sm " title="Lihat Proses Detail"><i class="fe fe-arrow-right"></i></a>';
															if((parseInt(row.selisih_kurang)>0) || (parseInt(row.selisih_lebih)>0)) {
																btn_group = btn_group + '<a href="<?php echo $link_view_selisih ?>/' + row.id + '" class="btn btn-default text-red btn-sm " title="Berita Acara Selisih" target="_blank"><i class="fe fe-folder-minus"></i></a>';
															}
