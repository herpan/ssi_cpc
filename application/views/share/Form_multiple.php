...
<a class="btn btn-success" href="<?php echo $link_download_template?>"><i class="fa fa-cloud-download mr-2"></i>Download Template</a>
</div>

<div class="alert alert-icon alert-success" role="alert">
  <i class="fe fe-check mr-2" aria-hidden="true"></i><small>Step 1. Download Template</small><br>
  ...
  <i class="fe fe-check mr-2" aria-hidden="true"></i><small>Step 4. Lihat informasi Upload</small>
</div>
...
<div class="card">
  ...
  <div class="alert alert-icon alert-primary" role="alert">
	<a class="btn btn-primary" href="<?php echo $link_back?>"><i class="fa fa-arrow-left mr-2"></i>Kembali</a>
  </div>
