...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_kondisi_kategori_id ?></label> 
							<?php $v='';  if(isset($data)) $v = $data->kategori_id; 
								  echo create_cmb_database(array(	'id'			=>'kategori_id',
																	'name'			=>'kategori_id',
																	'table'			=>'app_kategori_kondisi',
																	'field_show'	=>'nama_kategori',
																	'primary_key'	=>'id', 
																	'selected'		=>$v,
																	'field_link'	=>'',
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_kondisi_kondisi ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='kondisi' name='kondisi' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->kondisi ?>' >
					</div>
					</div>
