...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_kategori_kondisi_nama_kategori ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='nama_kategori' name='nama_kategori' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->nama_kategori ?>' >
					</div>
					</div>
