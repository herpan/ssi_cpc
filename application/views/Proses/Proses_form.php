...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_journal_proses_uang_masuk_detail_id ?></label> 
							<?php $v='';  if(isset($data)) $v = $data->uang_masuk_detail_id; 
								  echo create_cmb_database(array(	'id'			=>'uang_masuk_detail_id',
																	'name'			=>'uang_masuk_detail_id',
																	'table'			=>'app_uang_masuk_detail',
																	'field_show'	=>'uang_masuk_id',
																	'primary_key'	=>'id', 
																	'selected'		=>$v,
																	'field_link'	=>'',
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_journal_proses_emisi_id ?></label> 
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_journal_proses_kondisi_id ?></label> 
							<?php $v='';  if(isset($data)) $v = $data->kondisi_id; 
								  echo create_cmb_database(array(	'id'			=>'kondisi_id',
																	'name'			=>'kondisi_id',
																	'table'			=>'app_kondisi',
																	'field_show'	=>'kategori_id',
																	'primary_key'	=>'id', 
																	'selected'		=>$v,
																	'field_link'	=>'',
																	'class'			=>'custom-select data-sending')); 
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_journal_proses_jumlah ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_journal_proses_status ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_journal_proses_tanggal_pencatatan ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_journal_proses_keterangan ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_journal_proses_input_time ?></label>
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_journal_proses_user_update ?></label> 
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_journal_proses_update_time ?></label>
