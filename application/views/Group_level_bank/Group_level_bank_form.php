...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_level_bank_level_id ?></label> 
							<?php $v='';  if(isset($data)) $v = $data->level_id; 
								  echo create_cmb_database(array(	'id'			=>'level_id',
																	'name'			=>'level_id',
																	'table'			=>'sys_level',
																	'field_show'	=>'nmlevel',
																	'primary_key'	=>'id', 
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_level_bank_bank_id ?></label> 
