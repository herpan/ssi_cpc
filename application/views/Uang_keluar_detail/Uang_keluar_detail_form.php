...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_uang_keluar_detail_uang_keluar_id ?></label> 
							<?php $v='';  if(isset($data)) $v = $data->uang_keluar_id; 
								  echo create_cmb_database(array(	'id'			=>'uang_keluar_id',
																	'name'			=>'uang_keluar_id',
																	'table'			=>'app_uang_keluar',
																	'field_show'	=>'no',
																	'primary_key'	=>'id', 
																	'selected'		=>$v,
																	'field_link'	=>'',
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_uang_keluar_detail_jenis_uang_id ?></label> 
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_uang_keluar_detail_pecahan_id ?></label> 
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_uang_keluar_detail_jumlah ?></label>
