...
<?php echo card_open('Daftar Level','bg-teal',true)?>

<div class="row">
<div class="col-md-6 col-lg-4">
<?php echo button_card("Buat Baru","new Level",'text-green','btn-success','fe fe-list','bg-green','btn-create',$link_create)?>
</div>
<div class="col-md-6 col-lg-4">
