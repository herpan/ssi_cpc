...
<div class="col-lg-3">
	...
	<ul class="list-unstyled list-separated">	
		...
		<a href="<?php echo base_url()?>sistem/Dokumentasi_109/bot_telegram" class="list-group-item list-group-item-action <?php if(strtolower($page)=="bot_telegram"){ echo " active";}?>"><span class="icon mr-3"><i class="fa fa-send"></i></span><span class="tag tag-indigo" style="font-size:10px;cursor:pointer">BOT TELEGRAM</span></a>
		</div>				
	</ul>
	</div>
