...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							...
							<input type='text' class='form-control data-sending focus-color ybs-input-number' id='kode_bank' name='kode_bank' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo number_format($data->kode_bank,2) ?>' autocomplete='off'>
					</div>
					</div>
					...
					<div class='form-group'>
							...
							<input type='text' class='form-control data-sending focus-color input-alfa'  id='bank' name='bank' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->bank ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_bank_input_time ?></label>
					...
					<div class='col-md-12 col-xl-12'>				
					<div class='form-group'> 
							<label class='form-label'><?php echo $title->app_bank_user_update ?></label> 
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->app_bank_update_time ?></label>
