...
class Pecahan_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_pecahan_id	= 'ID';
		$this->app_pecahan_pecahan	= 'PECAHAN';
		$this->app_pecahan_keterangan	= 'KETERANGAN';
		$this->app_pecahan_user_input	= 'USER_INPUT';
		$this->app_pecahan_input_time	= 'INPUT_TIME';
		$this->app_pecahan_user_update	= 'USER_UPDATE';
		$this->app_pecahan_update_time	= 'UPDATE_TIME';
...
/* Generated by YBS CRUD Generator 2021-11-30 17:02:08 */
