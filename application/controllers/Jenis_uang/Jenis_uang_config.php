...
class Jenis_uang_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_jenis_uang_id	= 'ID';
		$this->app_jenis_uang_jenis_uang	= 'JENIS_UANG';
		$this->app_jenis_uang_keterangan	= 'KETERANGAN';
		$this->app_jenis_uang_user_input	= 'USER_INPUT';
		$this->app_jenis_uang_input_time	= 'INPUT_TIME';
		$this->app_jenis_uang_user_update	= 'USER_UPDATE';
		$this->app_jenis_uang_update_time	= 'UPDATE_TIME';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_jenis_uang_id,
			$this->f_jenis_uang	=> $this->app_jenis_uang_jenis_uang,
			$this->f_keterangan	=> $this->app_jenis_uang_keterangan,
			// $this->f_user_input	=> $this->app_jenis_uang_user_input,
			$this->f_nama_lengkap	=> $this->userinput_nama_lengkap,
			$this->f_input_time	=> $this->app_jenis_uang_input_time,
			// $this->f_user_update	=> $this->app_jenis_uang_user_update,
			$this->f_userupdate_nama_lengkap	=> $this->userupdate_nama_lengkap,
			$this->f_update_time	=> $this->app_jenis_uang_update_time,
...
/* Generated by YBS CRUD Generator 2021-11-30 17:05:58 */
