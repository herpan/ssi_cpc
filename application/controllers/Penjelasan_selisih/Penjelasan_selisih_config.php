...
class Penjelasan_selisih_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_penjelasan_selisih_id	= 'ID';
		$this->app_penjelasan_selisih_uang_masuk_id	= 'UANG_MASUK_ID';
		$this->app_penjelasan_selisih_penjelasan	= 'PENJELASAN';
		$this->app_penjelasan_selisih_jam	= 'JAM';
		$this->app_penjelasan_selisih_kamera	= 'KAMERA';
		$this->app_penjelasan_selisih_no_seri	= 'NO_SERI';
		$this->app_penjelasan_selisih_user_input	= 'USERID_INPUT';
		$this->app_penjelasan_selisih_input_time	= 'INPUT_TIME';
		$this->app_penjelasan_selisih_user_update	= 'USERID_UPDATE';
		$this->app_penjelasan_selisih_update_time	= 'UPDATE_TIME';
		...
		$this->f_penjelasan	= 'penjelasan';
		$this->f_jam	= 'jam';
		$this->f_kamera	= 'kamera';
		$this->f_no_seri	= 'no_seri';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_penjelasan_selisih_id,
			$this->f_uang_masuk_id	=> $this->app_penjelasan_selisih_uang_masuk_id,
			$this->f_penjelasan	=> $this->app_penjelasan_selisih_penjelasan,
			$this->f_jam	=> $this->app_penjelasan_selisih_jam,
			$this->f_kamera	=> $this->app_penjelasan_selisih_kamera,
			$this->f_no_seri	=> $this->app_penjelasan_selisih_no_seri,
			$this->f_user_input	=> $this->app_penjelasan_selisih_user_input,
			$this->f_input_time	=> $this->app_penjelasan_selisih_input_time,
			$this->f_user_update	=> $this->app_penjelasan_selisih_user_update,
			$this->f_update_time	=> $this->app_penjelasan_selisih_update_time,
...
/* Generated by YBS CRUD Generator 2022-01-03 11:07:25 */
