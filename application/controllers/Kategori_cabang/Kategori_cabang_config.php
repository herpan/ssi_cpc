...
class Kategori_cabang_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_kategori_cabang_id	= 'ID';
		$this->app_kategori_cabang_kategori_cabang	= 'KATEGORI_CABANG';
		$this->app_kategori_cabang_user_input	= 'USERID_INPUT';
		$this->app_kategori_cabang_input_time	= 'INPUT_TIME';
		$this->app_kategori_cabang_user_update	= 'USERID_UPDATE';
		$this->app_kategori_cabang_update_time	= 'UPDATE_TIME';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_kategori_cabang_id,
			$this->f_kategori_cabang	=> $this->app_kategori_cabang_kategori_cabang,
			//$this->f_user_input	=> $this->app_kategori_cabang_user_input,
			$this->f_nama_lengkap	=> $this->userinput_nama_lengkap,
			$this->f_input_time	=> $this->app_kategori_cabang_input_time,
			//$this->f_user_update	=> $this->app_kategori_cabang_user_update,
			$this->f_userupdate_nama_lengkap	=> $this->userupdate_nama_lengkap,
			$this->f_update_time	=> $this->app_kategori_cabang_update_time,
...
/* Generated by YBS CRUD Generator 2021-12-03 17:25:05 */
