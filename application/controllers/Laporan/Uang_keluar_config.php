...
class Uang_keluar_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_uang_keluar_status_pengiriman	= 'STATUS_PENGIRIMAN';
		$this->app_uang_keluar_tanggal_pengiriman	= 'TANGGAL_PENGIRIMAN';
		$this->app_uang_keluar_waktu_kirim	= 'WAKTU_KIRIM';
		...
		$this->f_status_pengiriman	= 'status_pengiriman';
		$this->f_tanggal_pengiriman	= 'tanggal_pengiriman';
		$this->f_waktu_kirim	= 'waktu_kirim';
		...
		$this->table_column =array(
			...
			$this->f_status_pengiriman	=> $this->app_uang_keluar_status_pengiriman,
			$this->f_tanggal_pengiriman	=> $this->app_uang_keluar_tanggal_pengiriman,
			$this->f_waktu_kirim	=> $this->app_uang_keluar_waktu_kirim,
