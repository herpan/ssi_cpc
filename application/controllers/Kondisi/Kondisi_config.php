...
class Kondisi_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_kondisi_id	= 'ID';
		$this->app_kondisi_kategori_id	= 'KATEGORI_ID';
		$this->app_kondisi_kondisi	= 'KONDISI';
		$this->app_kondisi_user_input	= 'USER_INPUT';
		$this->app_kondisi_input_time	= 'INPUT_TIME';
		$this->app_kondisi_user_update	= 'USER_UPDATE';
		$this->app_kondisi_update_time	= 'UPDATE_TIME';
		$this->kat_id	= 'KAT_ID';
		$this->kat_nama_kategori	= 'NAMA_KATEGORI';
		$this->kat_user_input	= 'KAT_USER_INPUT';
		$this->kat_input_time	= 'KAT_INPUT_TIME';
		$this->kat_user_update	= 'KAT_USER_UPDATE';
		$this->kat_update_time	= 'KAT_UPDATE_TIME';
		...
		$this->f_kat_id	= 'kat_id';
		$this->f_nama_kategori	= 'nama_kategori';
		$this->f_kat_user_input	= 'kat_user_input';
		$this->f_kat_input_time	= 'kat_input_time';
		$this->f_kat_user_update	= 'kat_user_update';
		$this->f_kat_update_time	= 'kat_update_time';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_kondisi_id,
			//$this->f_kategori_id	=> $this->app_kondisi_kategori_id,
			$this->f_nama_kategori	=> $this->kat_nama_kategori,
			$this->f_kondisi	=> $this->app_kondisi_kondisi,
			//$this->f_user_input	=> $this->app_kondisi_user_input,
			$this->f_nama_lengkap	=> $this->userinput_nama_lengkap,
			$this->f_input_time	=> $this->app_kondisi_input_time,
			//$this->f_user_update	=> $this->app_kondisi_user_update,
			$this->f_userupdate_nama_lengkap	=> $this->userupdate_nama_lengkap,
			$this->f_update_time	=> $this->app_kondisi_update_time,
			// $this->f_kat_id	=> $this->kat_id,
			// $this->f_nama_kategori	=> $this->kat_nama_kategori,
			// $this->f_kat_user_input	=> $this->kat_user_input,
			// $this->f_kat_input_time	=> $this->kat_input_time,
			// $this->f_kat_user_update	=> $this->kat_user_update,
			// $this->f_kat_update_time	=> $this->kat_update_time,
...
/* Generated by YBS CRUD Generator 2021-12-01 14:04:37 */
