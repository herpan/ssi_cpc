...
class Uang_keluar_detail_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_uang_keluar_detail_id	= 'ID';
		$this->app_uang_keluar_detail_uang_keluar_id	= 'NO_BA';
		$this->app_uang_keluar_detail_jenis_uang_id	= 'JENIS_UANG';
		$this->app_uang_keluar_detail_pecahan_id	= 'PECAHAN';
		$this->app_uang_keluar_detail_jumlah	= 'JUMLAH';
		$this->app_uang_keluar_detail_user_input	= 'USERID_INPUT';
		$this->app_uang_keluar_detail_input_time	= 'INPUT_TIME';
		$this->app_uang_keluar_detail_user_update	= 'USERID_UPDATE';
		$this->app_uang_keluar_detail_update_time	= 'UPDATE_TIME';
		$this->u_id	= 'U_ID';
		$this->u_no	= 'NO';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_uang_keluar_detail_id,
			//$this->f_uang_keluar_id	=> $this->app_uang_keluar_detail_uang_keluar_id,
			$this->f_no	=> $this->u_no,
			// $this->f_jenis_uang_id	=> $this->app_uang_keluar_detail_jenis_uang_id,
			$this->f_jenis_uang	=> $this->j_jenis_uang,
			// $this->f_pecahan_id	=> $this->app_uang_keluar_detail_pecahan_id,
			$this->f_pecahan	=> $this->p_pecahan,
			$this->f_jumlah	=> $this->app_uang_keluar_detail_jumlah,
			//$this->f_user_input	=> $this->app_uang_keluar_detail_user_input,
			$this->f_nama_lengkap	=> $this->userinput_nama_lengkap,
			$this->f_input_time	=> $this->app_uang_keluar_detail_input_time,			
			//$this->f_user_update	=> $this->app_uang_keluar_detail_user_update,
			$this->f_userupdate_nama_lengkap	=> $this->userupdate_nama_lengkap,
			$this->f_update_time	=> $this->app_uang_keluar_detail_update_time,
