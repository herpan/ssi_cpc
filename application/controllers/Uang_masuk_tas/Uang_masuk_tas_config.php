...
class Uang_masuk_tas_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_uang_masuk_tas_id	= 'ID';
		$this->app_uang_masuk_tas_uang_masuk_id	= 'UANG_MASUK_ID';
		$this->app_uang_masuk_tas_no_segel	= 'NO_SEGEL';
		$this->app_uang_masuk_tas_no_tas	= 'NO_TAS';
		$this->app_uang_masuk_tas_keterangan	= 'KETERANGAN';
		$this->app_uang_masuk_tas_user_input	= 'USERID_INPUT';
		$this->app_uang_masuk_tas_input_time	= 'INPUT_TIME';
		$this->app_uang_masuk_tas_user_update	= 'USERID_UPDATE';
		$this->app_uang_masuk_tas_update_time	= 'UPDATE_TIME';
		$this->u_id	= 'U_ID';
		$this->u_no	= 'NO';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_uang_masuk_tas_id,
			//$this->f_uang_masuk_id	=> $this->app_uang_masuk_tas_uang_masuk_id,
			$this->f_no_segel	=> $this->app_uang_masuk_tas_no_segel,
			$this->f_no_tas	=> $this->app_uang_masuk_tas_no_tas,
			$this->f_keterangan	=> $this->app_uang_masuk_tas_keterangan,
			//$this->f_user_input	=> $this->app_uang_masuk_tas_user_input,
			$this->f_nama_lengkap	=> $this->userinput_nama_lengkap,
			$this->f_input_time	=> $this->app_uang_masuk_tas_input_time,
			//$this->f_user_update	=> $this->app_uang_masuk_tas_user_update,
			$this->f_userupdate_nama_lengkap	=> $this->userupdate_nama_lengkap,
			$this->f_update_time	=> $this->app_uang_masuk_tas_update_time,
