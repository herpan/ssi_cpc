<?php
require APPPATH. '/controllers/Uang_masuk_tas/Uang_masuk_tas_config.php';
...
class Uang_masuk_tas extends CI_Controller {
   ...
   function __construct(){
		...
		$this->title = new Uang_masuk_tas_config();
   }
	...
	public function index(){
		$data = array(
			...
			'title'					=> $this->title,
			'link_refresh_table'	=> site_url().'Uang_masuk_tas/Uang_masuk_tas/refresh_table/'.$this->_token,
			'link_create'			=> site_url().'Uang_masuk_tas/Uang_masuk_tas/create',
			'link_update'			=> site_url().'Uang_masuk_tas/Uang_masuk_tas/update',
			'link_delete'			=> site_url().'Uang_masuk_tas/Uang_masuk_tas/delete_multiple',
			'link_create_multiple'			=> site_url().'Uang_masuk_tas/Uang_masuk_tas/create_multiple',
		);
		
		$this->template->load('Uang_masuk_tas/Uang_masuk_tas_list',$data);
	}
	...
	public function create(){
		$data = array(
			...
			'title'					=> $this->title,
			'link_save'				=> site_url().'Uang_masuk_tas/Uang_masuk_tas/create_action',
			'link_back'				=> $this->agent->referrer(),			
		);
		
		$this->template->load('Uang_masuk_tas/Uang_masuk_tas_form',$data);
		...
		**/
		...
		if($row){
			$data = array(
				'title_page_big'		=> 'Buat Baru',
				'title'					=> $this->title,
				'link_save'				=> site_url().'Uang_masuk_tas/Uang_masuk_tas/update_action',
				'link_back'				=> $this->agent->referrer(),
				'data'					=> $row,
				'id'					=> $id_generate,
			);
	...
	public function  create_multiple(){
		$data = array(
			...
			'link_download_template'	=> site_url().'Uang_masuk_tas/Uang_masuk_tas/download_template/'.$this->_token,
			'link_upload_template'		=> site_url().'Uang_masuk_tas/Uang_masuk_tas/upload_template/'.$this->_token,
			'link_back'					=> $this->agent->referrer(),			
		);
