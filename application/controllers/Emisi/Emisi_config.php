...
class Emisi_config {
   ...
   function __construct(){
	   /* title */
		...
		$this->app_emisi_id	= 'ID';
		$this->app_emisi_emisi	= 'EMISI';
		$this->app_emisi_keterangan	= 'KETERANGAN';
		$this->app_emisi_user_input	= 'USERID_INPUT';
		$this->app_emisi_input_time	= 'INPUT_TIME';
		$this->app_emisi_user_update	= 'USERID_UPDATE';
		$this->app_emisi_update_time	= 'UPDATE_TIME';
		...
		$this->table_column =array(
			$this->f_id	=> $this->app_emisi_id,
			$this->f_emisi	=> $this->app_emisi_emisi,
			$this->f_keterangan	=> $this->app_emisi_keterangan,
			//$this->f_user_input	=> $this->app_emisi_user_input,
			$this->f_nama_lengkap	=> $this->userinput_nama_lengkap,
			$this->f_input_time	=> $this->app_emisi_input_time,
			//$this->f_user_update	=> $this->app_emisi_user_update,
			$this->f_userupdate_nama_lengkap	=> $this->userupdate_nama_lengkap,
			$this->f_update_time	=> $this->app_emisi_update_time,
...
/* Generated by YBS CRUD Generator 2021-11-30 16:55:03 */
